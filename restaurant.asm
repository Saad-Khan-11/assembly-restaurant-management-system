...
len dw ?
 ...
 msg8  dw "Press options to choose any of the following $"
  
 msg9  dw "                    1)French toast               2$"           
 ...
 msg16 dw "                    1)Peas pulao with carrot raita 4$"
